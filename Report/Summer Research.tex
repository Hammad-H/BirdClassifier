...
%The graphs below show the training progress of the original network on the original data set and the training progress of the adversarial %network on the new data set containing both the original images as well as the adversarial images.
